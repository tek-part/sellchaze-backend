...
class StoreResource extends JsonResource
{
    ...
    {
        $urls = app(StorefrontUrlGenerator::class);
        ...
        return [
            ...
            'status' => $this->status,
            'subdomain_host' => $urls->tenantHost($this->resource),
