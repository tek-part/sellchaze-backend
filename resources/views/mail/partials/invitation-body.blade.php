...
<p style="margin:0 0 16px;">{{ __('You have been invited to join :app.', ['app' => $app_name]) }}</p>
...
@if(!empty($invite_code))
    <p style="margin:0 0 8px;font-size:14px;">{{ __('Your invite code is: :code', ['code' => $invite_code]) }}</p>
