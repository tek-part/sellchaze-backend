                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <p class="mb-0 text-muted small">{{ __('Update category details.') }}</p>
                        </div>
                        <div class="col-auto">
                    ...
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-4">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" class="form-control" placeholder="{{ __('Category Name') }}" required>
                            </div>
                        </div>
                        <div class="d-flex gap-2 mt-4 pt-3 border-top">
                            ...
                            <a href="{{ route('categories.index') }}" class="btn btn-light">{{ __('Cancel') }}</a>
                        </div>
                    </form>
                </div>
            </div>
