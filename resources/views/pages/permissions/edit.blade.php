                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <p class="mb-0 text-muted small">{{ __('Update permission details.') }}</p>
                        </div>
                        <div class="col-auto">
                    ...
                    <form action="{{ route('permissions.update', $permission->id) }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-4">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $permission->name) }}" class="form-control" placeholder="{{ __('Permission Name') }}" required>
                            </div>
                        </div>
